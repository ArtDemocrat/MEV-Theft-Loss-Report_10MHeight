...
## Introduction & Goals
During the first phase of the research in March 2024 conducted we were able to generate the findings which emphasized the relevance to look closer at the topic of MEV theft and loss within the Rocket Pool Protocol. However, we realized that we needed a more detailed investigation of MEV fee recipients and value by cross-referencing additional data sources and methods. For example, some of the theft findings presented in the initial report were contradictory between the sources of information we used. Therefore, upon the funding of this grant application we expand our methodology to include raw data from:
